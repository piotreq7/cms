 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="">
                        <a href="comments.php"><i class="fa fa-fw fa-wrench"></i> Komentarze</a>
                    </li>
                        <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="users.php">Wyświetl Użytkowników</a>
                            </li>
                            <li>
                                <a href="users.php?source=add_user">Dodaj Użytkownika</a>
                                        ...
                                        <li>
                        <a href="bootstrap-grid.html"><i class="fa fa-fw fa-wrench"></i> Profil</a>
                    </li>
