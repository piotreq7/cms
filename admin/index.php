...
$select_all_unaproved_post = mysqli_query($connection, $query);
$unaproved_post_count= mysqli_num_rows($select_all_unaproved_post);
...
<script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          <?php 
          $element_txt= ['Active post','Published post','Draft post','Comments','Unaproved Comments','Users','Admins','Categories'];
          $element_count= [$post_counts,$post_published_count,$post_draft_count,$comments_counts,$unaproved_post_count,$users_counts,$admin_count,$categories_counts];
